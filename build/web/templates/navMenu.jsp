...
<html>
    ...
    <nav class="navbar navbar-dark bg-dark"><!--Navbar content -->
        <a class="navbar-brand" style="font-family: fantasy" href="/TiendasArtesanales/validarCredenciales">AppWebITC</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav"><li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" style="font-family: fantasy" aria-labelledby="navbarDropdown">
                        ...
                        <div class="dropdown-divider"></div> 
                        <a class="dropdown-item" href="/TiendasArtesanales/rolUsuarioInit">Asignar rol a usuario</a>
                        <div class="dropdown-divider"></div> 
