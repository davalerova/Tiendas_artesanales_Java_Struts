...
<html>
    ...
    <body>
        ...
        <div class="contenedor">
            <form>
                <h1>&bull; Creaci&oacute;n de usuario artesano&bull; </h1>
                ...
                <button type="submit" class="btn2">Adjuntar RUT</button><br />
                <input type="password" placeholder="Contrase&ntilde;a" maxlength="20" >
                <button type="submit" class="btn2">Adjuntar documento de identidad</button>
            </form>
